...
import sys
sys.path.append('/group/40174/peimingli/bradley/MTVCrafter')
...
sys.path.remove('/group/40174/peimingli/bradley/MTVCrafter')
...
extra_config=edict(
    ...
    resume_path="/group/40174/peimingli/bradley/MTVCrafter_weights/vqvae_experiment/joint_and_image/joint3d_image_affined_192x256/f16s1d16_cb4096x2048_mpjpe/hrFix_lvl3_ratio0.5/models/checkpoint_epoch_106_step_480000"
