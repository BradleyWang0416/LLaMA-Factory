...
extra_config=edict(
    ...
    resume_path=osp.join(WEIGHT_ROOT_PATH, "vqvae_experiment/joint_and_image/joint3d_image_affined_192x256/f16s1d16_cb4096x2048_mpjpe_Tdown1-2/hrFix_lvl3_ratio0.5/models/checkpoint_epoch_185_step_300000")
)
