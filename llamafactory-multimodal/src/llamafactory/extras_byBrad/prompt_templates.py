# This file defines various prompt templates used for generating skeleton sequences from videos or text descriptions. It organizes templates into categories for easy access.
