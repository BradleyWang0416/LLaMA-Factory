...
save_subdir_vqvae=cb4096x2048_mpjpe_Tdown1-2/hrFix_lvl3_ratio0.5/step_500000
# save_subdir_jsonl=SkelPred/BodypartAwareExplicit
save_subdir_jsonl=h36m/SkelPred
...
data_stride=16
return_extra="[['image']]"
get_item_list="['sources','joint3d_image','joint3d_image_normed','factor_2_5d','joint3d_image_scale','joint3d_image_transl','video_rgb','joint3d_image_affined','joint3d_image_affined_normed','joint3d_image_affined_scale','joint3d_image_affined_transl','slice_id','image_sources','joint_2_5d_image','affine_trans','affine_trans_inv','joint2d','joint2d_cpn','joint3d_cam','joint3d_cam_rootrel_meter']"
save_item_list="[\
...
# resume_path=../MTVCrafter_weights/vqvae_experiment/joint_and_image/joint3d_image_affined_192x256/f16s1d16_cb4096x2048_mpjpe_Tdown1-2/hrFix_lvl3_ratio0.5/models/checkpoint_epoch_448_step_500000
resume_path=../MTVCrafter/vqvae_experiment/joint_and_image/joint3d_image_affined_192x256/f16s1d16_cb4096x2048_mpjpe_Tdown1-2/hrFix_lvl3_ratio0.5/models/checkpoint_epoch_448_step_500000
num_code=4096   # 8192
code_dim=2048   # 3072
batch_size=16
